        ...
        <div className='w-full min-h-screen bg-white sm:flex-col md:flex-row flex-col-reverse flex font-poppins'>
            <div className='sm:order-2 md:order-1 md:w-[60%] flex items-center justify-center sm:p-4 md:p-6'>
                ...
                <div className="sm:w-[300px] md:w-[350px] lg:w-[450px] mx-auto sm:*:text-[12px] lg:*:text-[14px] ">
                    ...
                    <input className='block w-full mx-auto border rounded-[3px] placeholder-[#676879] px-4 py-2 font-roboto' type="email" placeholder='jasmine'/>

                    <label htmlFor="" className="mt-4 mb-2 block">Last name</label>
                    <input className='block w-full mx-auto border rounded-[3px] placeholder-[#676879] px-4 py-2 font-roboto' type="email" placeholder='patel'/>
                    ...
                    <button className="block w-full bg-[#2692ff] hover:bg-[#438dd7] text-white mt-[30px] px-4 py-2 rounded-[3px]">Sign up</button>
            ...
            <div className='sm:order-1 md:order-2 sm:mb-5 md:mb-0 md:w-[40%] md:h-screen bg-[#2692ff] flex items-center justify-center py-14'>
                <img className='block object-cover' src={test} alt="" />
            </div>
        </div>
    )
}